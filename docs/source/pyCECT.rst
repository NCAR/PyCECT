...
pyCECT - python CESM Ensemble Consistency Test


pyCECT is used to compare the results of a set of new (modified)
CESM simulations against the accepted ensemble.  Current functionality in the CESM-ECT suite includes:
 
* CAM-ECT: examines yearly-average files from CAM (atmosphere component) 
* UF-CAM-ECT: examine history files from CAM (atmosphere component)
* POP-ECT: examines monthly-average files from POP (ocean component).  

CAM-ECT and UF-CAM-ECT require a summary file generated by 
...
2. CAM-ECT and UF-CAM-ECT specific options (and summary file generated by pyEnsSum.py)
    ...
    * I the specified indir contains more files than the number <num> specified by 
